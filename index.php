...
<body class="bg-dark">
    ...
    <main class="container mt-4">
        ...
        <!-- Inicio formulário de cadastro de novos usuarios -->
        <section class="row mt-5">
            <div class="col-lg-4 offset-lg-4 bg-light rounded" id="caixaRegistro">
                ...
                <form action="#" method="post" class="p-2" id="formRegistro">
                    <div class="form-group">
                        <input type="text" name="nomecCmpleto" id="nomeCompleto" class="form-control" placeholder="Nome Completo" required minlength="6">
                    </div>

                    <div class="form-group">
                        <input type="text" name="nomeUsuario" id="nomeUsuario" class="form-control" placeholder="Nome de Usuário" required minlength="6">
                    </div>
